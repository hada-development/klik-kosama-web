...
import { getPayrollComponent } from '../../Settings/PayrollComponent/data/services/service';
...
const ComponentEditForm: React.FC<ComponentEditFormProps> = (props) => {
  ...
  const onSubmit = (data: any) => {
    var param: Partial<EmployeeComponentFeature.PayrollComponentItem> = { id: props.values?.id };
    if (itemType == 'formula') {
      param = {
        ...param,
