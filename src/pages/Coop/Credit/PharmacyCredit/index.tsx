...
import { PharmacyCreditListItem } from './data/data';
import { getStoreLoanDataTable } from './data/service';

const PharmacyCreditListPage: React.FC = () => {
  ...
  const columns: ProColumns<PharmacyCreditListItem>[] = [
    {
      title: 'No Anggota',
      dataIndex: 'member_no',
    },
  ...
  return (
    <PageContainer>
      <ProTable<PharmacyCreditListItem, API.PageParams>
...
export default PharmacyCreditListPage;
