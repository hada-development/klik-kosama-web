...
import { CreditStatuses, GoodsCreditDetail } from '../data/data';
import { getGoodsCreditDetail } from '../data/service';

const GoodsCreditListPage: React.FC = () => {
  const { parameter } = useParams<{ parameter: string }>();
  const [detail, setDetail] = useState<GoodsCreditDetail | undefined>(undefined);
