...
const mapboxToken = 'pk.eyJ1IjoiaGF2aWFuc3lhaCIsImEiOiJja3VucWNuNTg0NGNqMnFtYWliYnV4N2pzIn0.X2I0v_kLMf6vCb9liGw_7A';
      ...
      >
        {
          ...
          <Marker longitude={parseFloat(props.values!.longitude)} latitude={parseFloat(props.values!.latitude)} anchor="bottom" color='#0085FF' />
        }
      </ReactMapGL>
